            ...
            <div class="container mx-auto mt-8">
                <table id="dataTable" class="table-auto w-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="border px-4 py-2 ">{{ $item->file_image }}</td>
                            <td class="border px-4 py-2 ">{{ $item->vehicle_id }}</td>
                            <td class="border px-4 py-2 ">{{ $item->part_id }}</td>
                            <td class="border px-4 py-2 ">{{ $item->quality_id }}</td>
                            <td class="border px-4 py-2 ">{{ $item->quality_id }}</td>
