            ...
            <div class="container mx-auto mt-8">
                <table id="dataTable" class="table-auto w-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="border px-4 py-2 dark:bg-gray-900">{{ $item->file_image }}</td>
                            <td class="border px-4 py-2 dark:bg-gray-900">{{ $item->vehicle_id }}</td>
                            <td class="border px-4 py-2 dark:bg-gray-900">{{ $item->part_id }}</td>
                            <td class="border px-4 py-2 dark:bg-gray-900">{{ $item->quality_id }}</td>
                            <td class="border px-4 py-2 dark:bg-gray-900">{{ $item->quality_id }}</td>
