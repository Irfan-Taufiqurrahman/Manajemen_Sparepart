<form method="POST" action="{{ route('maintenance.post') }}" enctype="multipart/form-data">
    ...
    <div class="md:flex md:items-center mb-6 mt-4">
        ...
        <div class="md:w-2/3">
            <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="description" name="description" type="text" placeholder="Barang Waktu Ganti" required>
        </div>
    </div>
